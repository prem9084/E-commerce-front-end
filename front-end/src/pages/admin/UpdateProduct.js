  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(
        `https://g-mart.onrender.com/api/v1/products/update-product/${id}`,
        productData
      );
      if (data?.success) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://g-mart.onrender.com/api/v1/products/delete-products/${id}`
      );
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://g-mart.onrender.com/api/v1/products/products-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
